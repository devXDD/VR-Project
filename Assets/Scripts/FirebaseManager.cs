...
// /*
    ...
    public void SaveDataButton()
    {
        ...
        // StartCoroutine(UpdateDeaths(int.Parse(DepthField.text)));
    }
    ...
    public void SaveData()
    {
        ...
        md.SpeedUser = usernameField.text;
        md.Depth = speedTextt.text;
    //     MetersDemo md = new MetersDemo();
    //    md.speeder = speedTextt.text;
        ...
        DBreference.Child("User").Child(md.SpeedUser).SetRawJsonValueAsync(json).ContinueWith(task => {
             if(task.IsCompleted)
             {
