...
public class HapticSurface : MonoBehaviour {
	...
	public float snapDistance = 10.0f; //!< When in HL_CONTRAINT mode, the maximum distance the stylus will "snap" to the surface.
...
/*
	...
	{
		 Debug.Log("Spawned");
			//var positionn = Vector3(Random.Range(-10, 10), 0, Random.Range(-10,10));
 			Instantiate(this.gameObject,Random.insideUnitSphere * 5 + transform.position, Quaternion.identity);
	}
	*/
